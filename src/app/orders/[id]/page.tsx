    ...
    return (
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="flex items-center mb-6">
          ...
          <div className="h-6 bg-gray-200 rounded w-40 animate-shimmer"></div>
        </div>

        <div className="bg-white rounded-lg shadow-md p-6 mb-6 animate-shimmer">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 animate-shimmer">
